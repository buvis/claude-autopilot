...
Paths like `${CLAUDE_PLUGIN_ROOT}/skills/use-codex/scripts/codex-run.sh` are intentionally hardcoded. This skill operates within a defined ecosystem where these paths are guaranteed. Dynamic resolution would add complexity without benefit.
