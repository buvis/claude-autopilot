...
The pure functions are exercised in-process here; the `autopilot check-plan`
exit-code contract (0 pass or override, 3 stall, 2 unreadable input) is pinned
as a real CLI process exit by test_check_plan_cli.py, which imports the fixture
helpers below.
"""
