...
- **Location**: `skills/run-autopilot/cli/render_report.py`, wired in `skills/run-autopilot/cli/__main__.py:756-782`
...
- **Location**: `skills/run-autopilot/cli/test_convergence.py` (new), `skills/run-autopilot/cli/test_loop.py`, `skills/run-autopilot/cli/test_render.py`, `skills/run-autopilot/cli/golden/metrics-render.jsonl`, `skills/run-autopilot/cli/golden/expected/report-section.md`; `skills/run-autopilot/scripts/test_review_prompt_contracts.py`; `skills/run-autopilot/references/phase-review.md`, `skills/run-autopilot/references/state-schema.md`, `skills/run-autopilot/references/batch-report-format.md`; `CHANGELOG.md`
